...
solar_df = pd.read_csv(
        r"C:\Users\kuipe\OneDrive\Bureaublad\Epoch\citylearn-2022-starter-kit\consumption_prediction\building_specific_models\building2_solar.csv")
...
# Average CV score on the training set was: -0.021640644884215084
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.8500000000000001, min_samples_leaf=1, min_samples_split=13, n_estimators=100)
